...
export default function Kidscard() {
  ...
  useEffect(() => {
    const rawData = localStorage.getItem("kidsproduct");
  ...
  return (
    <div className="p-6">
      ...
      <button onClick={()=>Router.push("Kidscategory")} className="text-ml text-gray-600 text-black-800 text-center mb-4">see more</button>
